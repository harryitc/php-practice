...
<body class="bg-light">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/Product/add"><i class="bi bi-plus-circle"></i> Thêm Sản Phẩm</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container form-container">
        ...
        <div class="row mb-4">
            <div class="col">
                <h1 class="text-center text-primary"><i class="bi bi-plus-circle"></i> Thêm Sản Phẩm Mới</h1>
            </div>
        </div>
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-primary text-white">
                <h5 class="card-title mb-0"><i class="bi bi-pencil-square"></i> Thông Tin Sản Phẩm</h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3"
                                          required placeholder="Nhập mô tả chi tiết về sản phẩm"></textarea>
                            </div>
                        </div>
                    </div>
